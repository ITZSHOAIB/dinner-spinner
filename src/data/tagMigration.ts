...
const migration: Record<string, CanonicalTag[]> = {
  ...
  'smoked': ['smoky'],
  'dum': ['slow-cooked'],
  'country-style': ['home-style'],
  'family-style': ['home-style'],
  'complex-spice': ['aromatic'],
  'herbal': ['aromatic'],
  'herb-forward': ['aromatic'],
  'hot-and-sour': ['tangy'],
  'pantry': ['everyday'],
  ...
  'gujarati': [], 'maharashtrian': [], 'goan': [], 'rajasthani': [],
  'hyderabadi': [], 'middle-eastern': [], 'surti': [],
  'coastal': [], 'sadya': [], 'keema': [], 'thali': [], 'tiffin': [],
  'wazwan': [], 'desert-cuisine': [], 'portuguese-heritage': [],
  'weekend-breakfast': ['weekend'], 'biryani-accompaniment': [],
  'curry': [], 'soup': [], 'salad': [], 'rice-bowl': [], 'bowl': [],
  'pasta': [], 'pizza': [], 'wrap': [], 'dip': [],
  'side-dish': [], 'starter': [], 'first-course': [], 'dumplings': [],
  'lentil-cakes': [], 'flatbread': [], 'dal': [], 'ramen': [], 'risotto': [],
  'sabzi': [], 'travel-food': [], 'delicate': [], 'no-onion-garlic': [],
  'complex': [], 'marinated': [], 'vinegar': [], 'pickle': [],
  'fenugreek': [], 'peanut': [],
